...
var CONFIG = {
  ...
  boundaries: [
    ...
    // Asset: GHS-UCDB R2024A, slim variant built by
    // scripts/ucdb_r2024a_to_gee_shapefile.py from the JRC R2024A GPKG.
    // 11,422 urban-centre polygons with ID_UC_G0 + UC_NM_MN + CTR_GADM +
    // CTR_UN attached. Reprojected to WGS84 before upload.
    // The earlier asset 'GHS_SMOD' was the R2023A SMOD-UC layer (11,534
